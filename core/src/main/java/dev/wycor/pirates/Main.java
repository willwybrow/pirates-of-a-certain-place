...
import static dev.wycor.pirates.SeaEvent.KRAKEN;
...
public class Main extends ApplicationAdapter {
    ...
    private static final float SQRT_3_OVER_2 = SQRT_3/2f;
    ...
    @Override
    public void render() {
        ScreenUtils.clear(0.16f/2f, 0.5f/2f, 0.725f/2f, 1f); // rgb(41, 128, 185)
    ...
    public float boundingBoxX(Hex hex) {
        ...
        // return (WORLD_WIDTH/2f - HEX_WIDTH) + (SQRT_3 * hex.q() + SQRT_3_OVER_2 * hex.r());
        // return (WORLD_WIDTH/2f - HEX_WIDTH) + hex.q() + (hex.r() % 2) * (HEX_WIDTH / 2f);
    }

    public float boundingBoxY(Hex hex) {
        return ((WORLD_HEIGHT/2f - HEX_HEIGHT)) + 3/4f * -hex.r();
//        return ((WORLD_HEIGHT/2f - HEX_HEIGHT)) + (1.5f * hex.r());
        // return (WORLD_HEIGHT/2f - HEX_HEIGHT) + hex.r() * 0.7f;
    }
}
